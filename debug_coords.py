...
from config import UI_TEMPLATES_DIR, UI_TEMPLATE_THRESHOLD
...
def main():
    ...
    # 保存图片用于点击
    click_img_path = "debug_click.png"
    ...
    cv2.imwrite("debug_verification.png", verification_image)

    print("\n验证图片已保存: debug_verification.png")
